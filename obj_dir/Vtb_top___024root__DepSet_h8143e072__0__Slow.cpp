...
VL_ATTR_COLD void Vtb_top___024root___eval_static__TOP(Vtb_top___024root* vlSelf) {
    ...
    vlSelfRef.tb_top__DOT__dut__DOT__por = 0U;
...
VL_ATTR_COLD void Vtb_top___024root___ctor_var_reset(Vtb_top___024root* vlSelf) {
    ...
    vlSelf->tb_top__DOT__dut__DOT__por = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 14190494797712875257ull);
    ...
    vlSelf->tb_top__DOT__dut__DOT__tail_xy = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 1832703162671360623ull);
    ...
    vlSelf->tb_top__DOT__dut__DOT__pop_w = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14511862557306429257ull);
    vlSelf->tb_top__DOT__dut__DOT__next_x = VL_SCOPED_RAND_RESET_I(6, __VscopeHash, 12742526336386918769ull);
    vlSelf->tb_top__DOT__dut__DOT__next_y = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 552044524991325890ull);
    ...
    vlSelf->tb_top__DOT__dut__DOT__sb__DOT__tail_val = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 701561394797329779ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 30; ++__Vi0) {
        vlSelf->tb_top__DOT__dut__DOT__sm__DOT__occ[__Vi0] = VL_SCOPED_RAND_RESET_Q(40, __VscopeHash, 2496887979351219455ull);
    }
    vlSelf->tb_top__DOT__dut__DOT__sm__DOT__r = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15031827032022494156ull);
    vlSelf->tb_top__DOT__dut__DOT__sm__DOT____Vlvbound_h880d8971__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16452069028427031877ull);
    vlSelf->tb_top__DOT__dut__DOT__sm__DOT____Vlvbound_h1d527880__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17583058444981315365ull);
